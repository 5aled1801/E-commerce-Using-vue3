      ...
      <v-container fluid>
        <v-card elevation="0">
          <div class="text-center">
            ...
            <v-card-text>Get the latest updates on new products and upcoming sales</v-card-text>

            <v-row class="mt-6 d-flex justify-center align-center">
              <v-col cols="12" class="d-flex flex-column flex-sm-row justify-center align-center">
                <input
                  type="text"
                  class="px-8 mx-2 w-sm-100"
                  width="100%"
                  placeholder="enter you email address"
                />
                <v-btn color="blue" class="px-8" rounded>Submit</v-btn>
              </v-col>
            </v-row>
          </div>
          <div class="mt-10">
            <v-row>
              <v-col cols="12" sm="6" md="4" lg="3">
                <h4>SHOP</h4>
                <v-card-text v-for="ca in categoroes" :key="ca.title">
                  <router-link
                    :to="{
                      name: 'produtCont',
              ...
              <v-col cols="12" sm="6" md="4" lg="3">
                <img src="./../../assets/images/footer-logo.webp" width="150" alt="" />
                <div class="d-flex">
                  <svg
                  ...
                  <span>685 Market Street<br />San Francisco, CA94105,US</span>
                </div>
                <div class="d-flex">
                  <svg
                    aria-hidden="true"
                    ...
                    role="img"
                    viewBox="0 0 512 512"
                    class="svg-inline--fa fa-phone-alt fa-w-16 fa-7x mr-5"
                    width="18px"
                  >
                    <path
                      fill="currentColor"
                ...
                <div class="d0flex">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    class="svg-inline--fa fa-envelope fa-w-16 fa-7x mr-5"
                    width="18px"
                  >
                    <path
                      fill="currentColor"
...
.footer-app {
  ...
  input {
    ...
    width: 35%;
    border-radius: 20px;
    border-color: #2195f338; /* Change to your desired color */
    box-shadow: 0 0 0 1px #1d23294e; /* Change to your desired color */
  }
  p,
  a {
    color: gray;
