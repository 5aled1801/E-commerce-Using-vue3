<template>
  <div class="nav-bar">
    <v-app-bar color="#04048f" class="pt-12" style="height: 146px; z-index: 100" absolute>
      <v-container fluid>
        <!-- <v-app-bar-nav-icon @click="opencar"></v-app-bar-nav-icon> -->
        <v-row>
          <v-col cols="3"
          ...
          <v-col cols="5">
            <div class="position-relative">
              <input
                ...
                name="searchinput"
                placeholder="Search"
                class="bg-white py-3 px-5 w-75 round"
          ...
          <v-col cols="4">
            <div
              class="avilablecont d-flex justify-space-around text-size-small"
            ...
            >
              ...
              <div
                class="avilableicon d-flex justift-space-around w-40 text-center"
                style="color: #c47f00; gap: 20px"
              >
                <div class="conavi">
                  <svg
                    viewBox="0 0 512 512"
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <div class="conavi" style="cursor: pointer" @click="openCart">
                  <v-badge
                    location="right top"
          ...
          <v-col cols="7">
            <ul class="links d-flex justify-space-around" style="list-style: none">
              <li v-for="ca in categoroes" :key="ca.title">
                <router-link
                  :to="{
                    name: 'produtCont',
                    params: { category: ca.route, title: ca.title }
                  }"
          ...
          <v-col cols="5">
            <div
              class="heplerusd d-flex justify-end text-size-small align-center"
            ...
            >
              <svg
                ...
                style="width: 22px; color: rgb(77 77 158); margin-inline-end: 10px"
              >
                <path
                  fill="currentColor"
              ...
              <span> Helper</span>
              <span class="mx-7" style="color: gray">|</span>
              <div id="langage" style="cursor: pointer; display: flex; text-align: center">
                <span v-html="selectedlang[0].flag"></span>
                <span> {{ selectedlang[0].country }} / {{ selectedlang[0].crun }} </span>
                <v-icon>mdi-chevron-down</v-icon>
              </div>
              <v-menu activator="#langage">
                <v-list v-model:selected="selectedlang" mandatory="">
                  <v-list-item v-for="lan in lang" :key="lan">
                    <v-list-item-title style="cursor: pointer; align-items: center">
                      <span v-html="lan.flag"> </span>
                      <span>{{ lan.country }} / {{ lan.crun }}</span>
                    </v-list-item-title>
                  </v-list-item>
                </v-list>
              </v-menu>
        ...
        },
        {
          flag: `<svg
                          ...
                          >
                            <path
                              style="fill: #ffda44"
                              d="M15.923,345.043C52.094,442.527,145.929,512,256,512s203.906-69.473,240.077-166.957L256,322.783  L15.923,345px.043z"
                            ></path>
                            <path
